...
import org.jayield.primitives.dbl.ops.DoubleAdvancerArray;
import org.jayield.primitives.dbl.ops.DoubleAdvancerConcat;
import org.jayield.primitives.dbl.ops.DoubleAdvancerDistinct;
import org.jayield.primitives.dbl.ops.DoubleAdvancerDropWhile;
import org.jayield.primitives.dbl.ops.DoubleAdvancerFilter;
import org.jayield.primitives.dbl.ops.DoubleAdvancerFlatMap;
import org.jayield.primitives.dbl.ops.DoubleAdvancerGenerate;
import org.jayield.primitives.dbl.ops.DoubleAdvancerIterate;
import org.jayield.primitives.dbl.ops.DoubleAdvancerLimit;
import org.jayield.primitives.dbl.ops.DoubleAdvancerMap;
import org.jayield.primitives.dbl.ops.DoubleAdvancerMapToObj;
import org.jayield.primitives.dbl.ops.DoubleAdvancerPeek;
import org.jayield.primitives.dbl.ops.DoubleAdvancerSkip;
import org.jayield.primitives.dbl.ops.DoubleAdvancerStream;
import org.jayield.primitives.dbl.ops.DoubleAdvancerTakeWhile;
import org.jayield.primitives.dbl.ops.DoubleAdvancerZip;
...
public class DoubleQuery {
    ...
    public static DoubleQuery fromStream(DoubleStream src) {
        DoubleAdvancerStream strm = new DoubleAdvancerStream(src);
    ...
    public static DoubleQuery iterate(double seed, DoubleUnaryOperator f) {
        DoubleAdvancerIterate iter = new DoubleAdvancerIterate(seed, f);
    ...
    public static DoubleQuery generate(DoubleSupplier s) {
        DoubleAdvancerGenerate gen = new DoubleAdvancerGenerate(s);
    ...
    public DoubleQuery filter(DoublePredicate p) {
        DoubleAdvancerFilter filter = new DoubleAdvancerFilter(this, p);
    ...
    public DoubleQuery map(DoubleUnaryOperator op) {
        DoubleAdvancerMap map = new DoubleAdvancerMap(this, op);
    ...
    public <U> Query<U> mapToObj(DoubleFunction<? extends U> function) {
        DoubleAdvancerMapToObj<U> map = new DoubleAdvancerMapToObj<>(this, function);
    ...
    public DoubleQuery flatMap(DoubleFunction<? extends DoubleQuery> function) {
        DoubleAdvancerFlatMap map = new DoubleAdvancerFlatMap(this, function);
        return new DoubleQuery(map, map);
    }
    ...
    public DoubleQuery distinct() {
        DoubleAdvancerDistinct dist = new DoubleAdvancerDistinct(this);
    ...
    public DoubleQuery sorted() {
        ...
        Arrays.sort(state);
        DoubleAdvancerArray arr = new DoubleAdvancerArray(state);
    ...
    public DoubleQuery peek(DoubleConsumer action) {
        DoubleAdvancerPeek peek = new DoubleAdvancerPeek(this, action);
    ...
    public DoubleQuery limit(int n) {
        DoubleAdvancerLimit lim = new DoubleAdvancerLimit(this, n);
    ...
    public DoubleQuery skip(int n) {
        DoubleAdvancerSkip skip = new DoubleAdvancerSkip(this, n);
   ...
   /**
    ...
    public static DoubleQuery of(double... data) {
        DoubleAdvancerArray arr = new DoubleAdvancerArray(data);
        return new DoubleQuery(arr, arr);
    }
    ...
    public final DoubleQuery takeWhile(DoublePredicate predicate) {
        DoubleAdvancerTakeWhile take = new DoubleAdvancerTakeWhile(this, predicate);
    ...
    public final DoubleQuery concat(DoubleQuery other) {
        DoubleAdvancerConcat cat = new DoubleAdvancerConcat(this, other);
    ...
    public final DoubleQuery dropWhile(DoublePredicate predicate) {
        DoubleAdvancerDropWhile drop = new DoubleAdvancerDropWhile(this, predicate);
    ...
    public final DoubleQuery zip(DoubleQuery other, DoubleBinaryOperator zipper) {
        DoubleAdvancerZip zip = new DoubleAdvancerZip(this, other, zipper);
