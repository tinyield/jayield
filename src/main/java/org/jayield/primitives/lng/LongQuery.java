...
import org.jayield.primitives.lng.ops.LongAdvancerArray;
import org.jayield.primitives.lng.ops.LongAdvancerConcat;
import org.jayield.primitives.lng.ops.LongAdvancerDistinct;
import org.jayield.primitives.lng.ops.LongAdvancerDropWhile;
import org.jayield.primitives.lng.ops.LongAdvancerFilter;
import org.jayield.primitives.lng.ops.LongAdvancerFlatMap;
import org.jayield.primitives.lng.ops.LongAdvancerGenerate;
import org.jayield.primitives.lng.ops.LongAdvancerIterate;
import org.jayield.primitives.lng.ops.LongAdvancerLimit;
import org.jayield.primitives.lng.ops.LongAdvancerMap;
import org.jayield.primitives.lng.ops.LongAdvancerMapToObj;
import org.jayield.primitives.lng.ops.LongAdvancerPeek;
import org.jayield.primitives.lng.ops.LongAdvancerSkip;
import org.jayield.primitives.lng.ops.LongAdvancerStream;
import org.jayield.primitives.lng.ops.LongAdvancerTakeWhile;
import org.jayield.primitives.lng.ops.LongAdvancerZip;
...
public class LongQuery {
    ...
    public static LongQuery fromStream(LongStream src) {
        LongAdvancerStream strm = new LongAdvancerStream(src);
    ...
    public static LongQuery iterate(long seed, LongUnaryOperator f) {
        LongAdvancerIterate iter = new LongAdvancerIterate(seed, f);
    ...
    public static LongQuery generate(LongSupplier s) {
        LongAdvancerGenerate gen = new LongAdvancerGenerate(s);
    ...
    public LongQuery filter(LongPredicate p) {
        LongAdvancerFilter filter = new LongAdvancerFilter(this, p);
    ...
    public LongQuery map(LongUnaryOperator op) {
        LongAdvancerMap map = new LongAdvancerMap(this, op);
    ...
    public <U> Query<U> mapToObj(LongFunction<? extends U> function) {
        LongAdvancerMapToObj<U> map = new LongAdvancerMapToObj<>(this, function);
    ...
    public LongQuery flatMap(LongFunction<? extends LongQuery> function) {
        LongAdvancerFlatMap map = new LongAdvancerFlatMap(this, function);
        return new LongQuery(map, map);
    }
    ...
    public LongQuery distinct() {
        LongAdvancerDistinct dis = new LongAdvancerDistinct(this);
    ...
    public LongQuery sorted() {
        ...
        Arrays.sort(state);
        LongAdvancerArray arr = new LongAdvancerArray(state);
    ...
    public LongQuery peek(LongConsumer action) {
        LongAdvancerPeek peek = new LongAdvancerPeek(this, action);
    ...
    public LongQuery limit(int n) {
        LongAdvancerLimit lim = new LongAdvancerLimit(this, n);
    ...
    public LongQuery skip(int n) {
        LongAdvancerSkip skip = new LongAdvancerSkip(this, n);
    ...
    public final LongQuery takeWhile(LongPredicate predicate) {
        LongAdvancerTakeWhile take = new LongAdvancerTakeWhile(this, predicate);
    ...
    public final LongQuery concat(LongQuery other) {
        LongAdvancerConcat cat = new LongAdvancerConcat(this, other);
    ...
    public final LongQuery dropWhile(LongPredicate predicate) {
        LongAdvancerDropWhile drop = new LongAdvancerDropWhile(this, predicate);
    ...
    public final LongQuery zip(LongQuery other, LongBinaryOperator zipper) {
        LongAdvancerZip zip = new LongAdvancerZip(this, other, zipper);
