...
public class QueryAdvanceTest {
    ...
    public void testFromAndToStream() {
        ...
        while(nrs
            ...
            .spliterator()
            .tryAdvance(actual ->
                assertEquals(actual, expected.next()))) {
        }
    ...
    public void testDistinctCount() {
        ...
        Query<String> pipe = Query
                ...
                .distinct();
        int total = 0;
        while(pipe.tryAdvance(__ -> {})) { total++; }
    ...
    public void testIterateLimitLast() {
        Query<Integer> pipe = Query
            ...
            .limit(7);
        int [] actual = { 0 };
        while(pipe.tryAdvance(n -> actual[0] = n));
        assertEquals(13, actual[0]);
    }
    ...
    public void testPeekCount() {
        ...
        int count = 0;
        while(pipe.tryAdvance(__ -> {})) count++;
